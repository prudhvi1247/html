            ...
            <div class="col-lg-5">              
                <?php if($post_created || $post_date || $post_client || $post_location || $post_surface_area || $post_project_value){ ?>
                    <div class="ps-informations">                 
                        <ul>
                          <li>
                            <span><?php esc_html_e('Category:', 'assuranc');?></span>
                            <?php 
                          ...
                          <?php if($post_client){?>
                          <li><span><?php esc_html_e('Client:','assuranc');?>  </span><?php   echo esc_html($post_client); ?></li>
                          <?php }?>

                          <?php if($post_location){?>
                          <li><span><?php esc_html_e('Location:','assuranc');?> </span><?php echo esc_html($post_location); ?></li>
                          <?php }?>

                          <?php if($post_surface_area){?>
                          <li><span><?php esc_html_e('Surface Area:','assuranc');?> </span><?php echo esc_html($post_surface_area).' m'; ?><sup><?php esc_html_e('2', 'assuranc'); ?></sup></li>
                          <?php }?>

                          <?php if($post_date){?>
                          <li><span><?php esc_html_e('Completed Date:','assuranc');?>  </span><?php   echo esc_html($post_date); ?></li>
                          <?php }?>
                          
                          <?php if($post_project_value){?>
                          <li><span><?php esc_html_e('Project Value:','assuranc');?>  </span><?php  echo esc_html($post_project_value); ?></li>
                          <?php }?>

                          <?php if($post_created){?>
                          <li><span><?php esc_html_e('Architect:','assuranc');?> </span><?php echo esc_html($post_created); ?></li>
                          <?php }?>
