...
final class Rsaddon_Elementor_Pro_Extension {
	...
	public function rsaddon_register_plugin_styles() {
		...
		wp_enqueue_script( 'instagram', $dir.'assets/js/rs-instagram.js' , array('jquery'), '201513434', true); 
        ...
        wp_enqueue_script( 'rsaddons-frontend-pro', $dir.'assets/js/frontend.js', '201513434', true);
        //wp_enqueue_script( 'jquery-parallax', $dir.'assets/js/parallax.min.js' , array('jquery'), '201513434', true );     	
    }
